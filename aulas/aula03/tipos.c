...
int main() {
  char caracter;       // carcteres 'a', 'A'
  int  inteiro;       // numeros inteiros + -
  float decimal16;   // numeros decimal com 6casas
  ...
  signed int inteiro_com_sinal // 4 byte -21bi a +21bi
  ...
  signed int inteiro_curto_com_sinal; // 2 bytes -32mil a +32mil
